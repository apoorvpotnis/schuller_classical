...
\newcommand{\nn}{\symbb{N}_0}
\newcommand{\rthree}{\rr\kern-0.5pt^3}
\newcommand{\rtwo}{\rr\kern-0.5pt^2}
...
\begin{document}
    ...
    % We try to define the directional derivative of a vector field. \(\e^{\i \pii} + 1 = 0, 4\pii\epsilon, n\pii\)

    \chapter{Lagrangian and the action functional}

    \[
        \operatorname{spec}_{\text{pp}}(A) = \{z \in \symbb{C} \mid \operatorname{ran}(A - z) = \overline{\operatorname{ran}(A - z)} \neq \symcal{H}\}
    \]
    \[
        \symcal{H}_\Gamma \symfrak{H}
    \]  
