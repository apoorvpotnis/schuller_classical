...
% arara: biber if found('log','Please (re)run Biber')
% arara: lualatex: { shell: yes } while found('log','Label(s) may have changed') || found('log','Please (re)run LaTeX')
...
\usepackage[sorting=none, hyperref, backref, backend=biber]{biblatex}
