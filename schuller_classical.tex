	...
	\begin{figure}[htb]
		...
		\begin{subfigure}[h]{0.4\textwidth}
			...
			\begin{tikzpicture}[scale=0.9]
			    \draw[std line width, dashed] (-1,-1) to [out=0, in=-90] (0,0) to [out=90, in=160] (1,0.5) to [out=-20, in=180] (2,0) to [out=0, in=-90] (3,1) to [out=90, in=180] (4,2);
				\draw[std line width] (0,0) to [out=90, in=160] (1,0.5) to [out=-20, in=180] (2,0) to [out=0, in=-90] (3,1) pic[pos=0.2] {code={\filldraw[fill=black] circle [radius=0.6pt];}};
			\end{tikzpicture}
		\end{subfigure}
		\caption{\(\gamma\)}
		\label{fig:gamma}
		...
		\begin{subfigure}[h]{0.4\textwidth}
			...
			\begin{tikzpicture}[scale=0.9]
				\draw[std line width, dashed] (-1,-1) to [out=0, in=-90] (0,0) to [out=90, in=160] (1,0.5) to [out=-20, in=180] (2,0) to [out=0, in=-90] (3,1) to [out=90, in=180] (4,2);
				\draw[std line width] (0,0) to [out=90, in=160] (1,0.5) to [out=-20, in=180] (2,0) to [out=0, in=-90] (3,1);
			\end{tikzpicture}
		\end{subfigure}
		\caption{\(\tilde\gamma\)}
		\label{fig:gammatilde}
		\captionof{figure}{Two particles having same path but different trajectories.}
		\label{fig:samepath}
	\end{figure}
